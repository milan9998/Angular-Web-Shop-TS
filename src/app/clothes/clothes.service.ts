...
export class ClothesService {
    ...
    getCart() {
        return this.cart; // Metoda za dohvatanje proizvoda iz niza
      }
    ...
    /*getClothesById(id: number): Clothes | undefined {
        var x !: Clothes;
        this.currentClothes = x;
        ClothesService.clothes.forEach(item =>{
            if(item.id==id){
                x=item;
            }
        })
